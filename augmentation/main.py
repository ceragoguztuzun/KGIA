...
def train(args, logger):
    ...
    # load data
    adj_label, features, dim_feat, adj_train, train_pairs, val_edges, val_edges_false, test_edges, test_edges_false, entity_to_int = load_custom_data(args,logger)#load_data(args, logger)
    ...
    T_f, edges_cf_t1, edges_cf_t0, T_cf, adj_cf = load_t_files(args, T_file, logger, adj_train, entity_to_int, features)
    ...
    # save edges 
    np.save('edges_f_t1.npy', edges_f_t1)
    np.save('edges_f_t0.npy', edges_f_t0)
    print('saved!!!')
